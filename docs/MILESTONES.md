...
- I8（同材料数值一致性「待核对问题」）：实现完成，待人工验收；独立 worktree F:\project\Preflight-i8 / 分支 i8-findings，未 merge（等 Grok）；提交 0c8d581，unittest 135 OK（其中 test_consistency 15 项先红后绿），check_contracts PASS，check-preflight-report 45/45，build 通过。
